...
export class Profile implements OnInit {
  ...
  constructor(public auth: AuthService, private apptSvc: AppointmentsService, private fb: FormBuilder) {}
  ...
  submit() {
    ...
    this.saving = true;
    setTimeout(() => {
      const updated: User = { ...this.user()!, nombre: this.form.get('nombre')!.value, telefono: this.form.get('telefono')!.value, fotoUrl: this.previewUrl() ?? this.user()?.fotoUrl };
